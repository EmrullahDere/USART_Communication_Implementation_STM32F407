...
#define __USART_BRR_OVERSAMPLING_8(__CLOCK__,__BAUDRATE__)			(25U * (uint32_t)(__CLOCK__) ) / ( 2U * (uint32_t)(__BAUDRATE__) )
#define __USART_BRR_OVERSAMPLING_16(__CLOCK__,__BAUDRATE__)			(25U * (uint32_t)(__CLOCK__) ) / ( 4U * (uint32_t)(__BAUDRATE__) )
...
typedef struct
{
	...
	uint32_t WordLength;			/*!< 8 Bits & 9 Bits Modes @def_group WordLenght_Types				*/
