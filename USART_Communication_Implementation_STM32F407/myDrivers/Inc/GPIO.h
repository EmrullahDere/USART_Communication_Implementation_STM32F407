 ...
 *
 */
#define GPIO_PIN_O 				(uint16_t)(0x0001) //0000 0000 0000 0001  	/*!< GPIO Pin 0 Selected 	*/
...
typedef struct
{
	...
	uint32_t PuPdr;		/*!> GPIO Pin Numbers @def_group GPIO_PuPd_Modes */
